...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Panel ID="Panel4" runat="server" Height="690px" Width="785px">
    <asp:GridView ID="GridView1" runat="server" Height="169px" 
        onselectedindexchanged="GridView1_SelectedIndexChanged" Width="782px" 
        ...
        <asp:Panel ID="Panel5" runat="server" BackColor="#CCCCFF" BorderColor="#66CCFF" 
            BorderStyle="Double" Height="499px" style="margin-bottom: 4px" 
            ...
            <table class="style2" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnsave" runat="server" onclick="btnsave_Click" Text="Reply" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
