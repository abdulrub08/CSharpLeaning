<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintRoomInfo.aspx.cs" Inherits="PrintRoomInfo" %>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="332px">
            <table class="style1">
                ...
                <tr>
                    <td class="Text">
                        Room Wise Details:</td>
                    <td>
                        <asp:DropDownList ID="ddlRoomNo" runat="server" AutoPostBack="True" 
