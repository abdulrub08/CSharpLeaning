<%@ Page Language="C#" MasterPageFile="~/MasterPageforsetup.master" AutoEventWireup="true" CodeFile="outbox.aspx.cs" Inherits="outbox" Title="Untitled Page" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Panel ID="Panel4" runat="server" Height="724px">
    <asp:Panel ID="Panel5" runat="server" BackColor="#CCCCFF" BorderColor="#66CCFF" 
        ...
        <table class="style2" 
            ...
            <tr>
                ...
                <td>
                    ...
                    <cc1:TextBoxWatermarkExtender ID="txtattach_TextBoxWatermarkExtender1" 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" 
            Height="217px" onselectedindexchanged="GridView1_SelectedIndexChanged1" 
            Width="895px" CellPadding="4" ForeColor="#333333" GridLines="None">
