<%@ Page Language="C#" MasterPageFile="~/MasterPageforsetup.master" AutoEventWireup="true" CodeFile="draft.aspx.cs" Inherits="draft" Title="Untitled Page" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Panel ID="Panel5" runat="server" Height="494px" Visible="False">
    <asp:Panel ID="Panel4" runat="server" Height="836px" Width="910px" 
    BackColor="#CCCCFF" BorderColor="#66CCFF" BorderStyle="Double" 
        ...
        <table class="style2" 
            ...
            style="font-family: Arial, Helvetica, sans-serif; font-size: large; color: #000000; font-variant: normal; font-style: normal; font-weight: normal; height: 716px; width: 99%;">
            <tr>
                <td style="color: #FFFFFF;" align="left" bgcolor="White" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" 
                        CellPadding="4" ForeColor="#333333" GridLines="None" 
                        onselectedindexchanged="GridView1_SelectedIndexChanged1" Height="182px" 
                        Width="819px">
            ...
            <tr>
                <td style="width: 89px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblcc" runat="server" 
                        Text="To CC:" Visible="False"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtbcc" runat="server" Height="22px" Width="592px" 
