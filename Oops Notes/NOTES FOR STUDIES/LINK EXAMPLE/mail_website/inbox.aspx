<%@ Page Language="C#" MasterPageFile="~/MasterPageforsetup.master" AutoEventWireup="true" CodeFile="inbox.aspx.cs" Inherits="inbox" Title="Untitled Page" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Panel ID="Panel4" runat="server" Height="688px" Width="901px">
        <asp:Panel ID="Panel5" runat="server" BackColor="#CCCCFF" BorderColor="#66CCFF" 
            BorderStyle="Double" Height="507px" style="margin-bottom: 4px" Visible="False" 
            Width="902px">
            <table class="style2" 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <asp:LinkButton ID="lnkaf1" runat="server" onclick="lnkaf1_Click" 
                            Visible="False"></asp:LinkButton>
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lnkaf2" runat="server" Visible="False"></asp:LinkButton>
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lnkaf3" runat="server" Visible="False"></asp:LinkButton>
                        &nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkaf4" runat="server" Visible="False"></asp:LinkButton>
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lnkaf5" runat="server" Visible="False"></asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td style="width: 89px">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" 
            ...
            onselectedindexchanged="GridView1_SelectedIndexChanged" Width="897px">
