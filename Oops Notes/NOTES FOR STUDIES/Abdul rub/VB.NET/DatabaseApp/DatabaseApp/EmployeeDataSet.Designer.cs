...
namespace DatabaseApp {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class empDataTable : global::System.Data.TypedTableBase<empRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public empRow AddempRow(int empno, string ename, int sal, string job) {
        ...
        public partial class empRow : global::System.Data.DataRow {
            ...
            public int sal {
                get {
                    try {
                        return ((int)(this[this.tableemp.salColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace DatabaseApp.EmployeeDataSetTableAdapters {
    ...
    public partial class empTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `emp` WHERE ((`empno` = ?) AND ((? = 1 AND `ename` IS NULL) OR (`enam" +
                "e` = ?)) AND ((? = 1 AND `sal` IS NULL) OR (`sal` = ?)) AND ((? = 1 AND `job` IS" +
                " NULL) OR (`job` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `emp` (`empno`, `ename`, `sal`, `job`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `emp` SET `empno` = ?, `ename` = ?, `sal` = ?, `job` = ? WHERE ((`empno` =" +
                " ?) AND ((? = 1 AND `ename` IS NULL) OR (`ename` = ?)) AND ((? = 1 AND `sal` IS " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseApp.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT empno, ename, sal, job FROM emp";
        ...
        public virtual int Fill(EmployeeDataSet.empDataTable dataTable) {
        ...
        public virtual EmployeeDataSet.empDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(global::System.Nullable<int> Original_empno, string Original_ename, global::System.Nullable<int> Original_sal, string Original_job) {
            ...
            if ((Original_sal.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_sal.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<int> empno, string ename, global::System.Nullable<int> sal, string job) {
        ...
        public virtual int Update(global::System.Nullable<int> empno, string ename, global::System.Nullable<int> sal, string job, global::System.Nullable<int> Original_empno, string Original_ename, global::System.Nullable<int> Original_sal, string Original_job) {
            if ((empno.HasValue == true)) {
            ...
            if ((Original_empno.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_empno.Value));
            }
            else {
            ...
            if ((Original_sal.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_sal.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ename, global::System.Nullable<int> sal, string job, global::System.Nullable<int> Original_empno, string Original_ename, global::System.Nullable<int> Original_sal, string Original_job) {
            return this.Update(Original_empno, ename, sal, job, Original_empno, Original_ename, Original_sal, Original_job);
        }
    }
